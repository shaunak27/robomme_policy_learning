#!/bin/bash
#SBATCH -Jtrain_density
#SBATCH --output=logs/train_density_%j.out
#SBATCH --error=logs/train_density_%j.err
...
HISTORY_CFG="perceptual-density-modul.yaml"
EXP_NAME="perceptual-density-modul"
BATCH_SIZE=256
FSDP_DEVICES=8
# -----------------------------------
...
cat <<EOF > "logs/train_density_config_$(date +%Y%m%d_%H%M%S).log"
